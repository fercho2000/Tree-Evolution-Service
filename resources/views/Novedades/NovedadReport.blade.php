...
<hr>
 ...
 <div class="container-fluid">
       <div class="row" >
           <div class="col-12">
           <p style="font-size:20px;" align="center"> <i class="fa fa-wrench" style="font-size:25px;"></i><strong>Implements in maintenance</strong></p>
            <hr>
            <hr>
           <div class="table-responsive">
             <table  class="table">
                 <thead>
                     <tr>
                         <td scope="row"><p style="font-size:12px;"><strong>Image</strong></p></td>
                         <td scope="row"><p style="font-size:12px;"><strong>Date</strong></p></td>
                         <td scope="row"><p style="font-size:12px;"><strong>Implement Code</strong></p></td>
                         <td scope="row"><p style="font-size:12px;"><strong>Implement Name</strong></p></td>
                         <td scope="row"><p style="font-size:12px;"><strong>Employee</strong></p></td>
                         <td scope="row"><p style="font-size:12px;"><strong>State</strong></p></td>
                     </tr>
                 </thead>
                 <tbody>
                    @foreach ($ImpleNovedad as $value)
                             <tr>                        
                                 <td style="text-align:center;"><img alt="" width="45px" height="45px"></td>
                                 <td><p style="font-size:12px;">{{$value->fecha_novedad}}</p> </td>
                                 <td> <p style="font-size:12px;">{{$value->codigo_implemento}}</p></td>
                                 <td> <p style="font-size:12px;">{{$value->nombre_implemento}}</p></td>
                                 <td> <p style="font-size:12px;">{{$value->nombre}} {{$value->apellido}}</p></td>
                                 <td> <p style="font-size:12px;">{{$value->estado==1 ? 'in maintenance' : 'Repaired'}}</p></td>
                             </tr>
                     @endforeach
                 </tbody>
             </table>
 ...
 <div class="container-fluid">
       <div class="row" >
           <div class="col-12">
           <p style="font-size:20px;" align="center"> <i class="fa fa-wrench" style="font-size:25px;"></i><strong>Repaired implements</strong></p>
            <hr>
            <hr>
           <div class="table-responsive">
             <table  class="table">
                 ...
                 <tbody>
                    @foreach ($ImpleNovedadRepa as $value)
                            <tr>                        
                                 <td style="text-align:center;"><img alt="" width="45px" height="45px"></td>
                                 <td><p style="font-size:12px;">{{$value->fecha_novedad}}</p> </td>
                                 <td> <p style="font-size:12px;">{{$value->codigo_implemento}}</p></td>
