...
<hr>
 ...
 <div class="container-fluid">
       <div class="row" >
           <div class="col-12">
            <h3 align="center"><strong>Consult attachments</strong></h3>
            <hr>
            <hr>
           <div class="table-responsive">
             <table  class="table  table-bordered">
                 <thead>
                     <tr>
                        <td scope="row"><p style="font-size:15px;"><strong>Image</strong></p></td>
                        <td scope="row"><p style="font-size:15px;"><strong>Implement Code</strong></p></td>
                        <td scope="row"><p style="font-size:15px;"><strong>Implement Name</strong></p></td>
                        <td scope="row"><p style="font-size:15px;"><strong>Category</strong></p></td>
                        <td scope="row"><p style="font-size:15px;"><strong>State</strong></p></td>
                     </tr>
                 </thead>
                 <tbody>
                    @foreach ($ImpleDispo as $value)
                             <tr>                        
                                 ...
                                 <td><p style="font-size:15px;">{{$value->estado==1 ? "Inactive":"Active"}}</p></td>
                             </tr>
                     @endforeach
                 </tbody>
             </table>
