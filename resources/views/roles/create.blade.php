...
<section class="content container-fluid">
    <form method="POST" action="{{url('roles/store')}}" onsubmit="return validation()">
        @csrf
        ...
        @endif 
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        ...
                        <div class="btn-group btn-group-toggle" data-toggle="buttons" style="padding-left: 17px !important;">
                            <div class="row">
                                <div class="">
                                    <label class="btn btn-success special">
                                        <input required type="radio" class="special1" name="special" id="option1" autocomplete="off" value=""> Assign Access
                                    </label>
                                </div>
                                <div class="">
                                    <label class="btn btn-success special">
                                        <input required type="radio" class="special1" name="special" id="option2" autocomplete="off" value="all-access"> All Access
                                    </label>
                                </div>
                                <div class="">
                                    <label class="btn btn-success special">
                                        <input required type="radio" class="special1" name="special" id="option3" autocomplete="off" value="no-access"> No Access
                                    </label>
                                </div>
                            </div>
                        </div>
                                                                ...
                                                                <div class="form-group">
                                                                    @foreach($permissions as $permission) 
                                                                        @if($permission->name==("Navegar Usuarios") || $permission->name==("Ver detalle Usuarios") || $permission->name==("Editar Usuarios") || $permission->name==("Eliminar Usuarios"))                            
                                                                                <input data-toggle="toggle" data-width="60" data-height="20" data-style="ios" data-on="Yes" data-off="No" type="checkbox" name="permissions[]" id="permission" value="{{ $permission->id }}">
                                                                                {{$permission->name}} ->
            ...
            <div class="form-group">
                ...
                <button type="submit" class="btn btn-success pull-right"><i  class="fas fa-save"></i> Save</button>
            </div>      
    </form>
</section>
@stop
