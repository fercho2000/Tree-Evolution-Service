...
$(document).ready(function () {
    $(".navigation .calendarheading").on('click',function () {
        $(this).find('ul li .calendar-badge small').addClass('badge1')
        alert("hi")
    });
    ...
    $("#color-chooser").find('li').on('click', function (e) {
        e.preventDefault();
        //Save color
...
$.ajax({
    type: "GET",
    url: "/Visita/consultacalendar",
    dataType: "JSON",
    async : false,
    success: function (respuesta) {
        Consvisita = respuesta
    }
});

// console.log(Consvisita);

$('#calendarioert').fullCalendar({
    header: {
        left: 'prev,next today',
        center: 'title',
        right: 'month,agendaWeek,agendaDay'
    ...
    eventSources: [
        '/Visita/consultacalendar',
        '/Agenda/calendar',
        '/Programacion/Agendar'
      ],
      ...
      dayClick: function(date, jsEvent, view, resourceObj) {
        ...
        var  actf = document.getElementById('fecha_inicio').value;
        if(actf>=today){
