...
$(document).ready(function () {
    ...
    $("#FechaInicio").dateDropper({
        format: "Y-m-d",
        dropPrimaryColor: "#428bca",
        
    });

    $("#UpdateFechaInicio").dateDropper({
      format: "Y-m-d",
        dropPrimaryColor: "#428bca",
        
    });
    
    $("#UpdateFechaFin").dateDropper({
        format: "Y-m-d",
        dropPrimaryColor: "#26DD79"
    });
 
    $("#FechaAgenda").dateDropper({
        format: "d/m/Y",
        dropPrimaryColor: "#428bca",
    ...
    $("#fechaNovedad").dateDropper({
        format: "d/m/Y",
        dropPrimaryColor: "#428bca",
        
    });
    
    $("#edit_fecha").dateDropper({
        format: "d/m/Y",
        dropPrimaryColor: "#428bca",
        
    });
    
    $("#FechaFin").dateDropper({
        format: "Y-m-d",
        dropPrimaryColor: "#26DD79"
    });
    
    $("#fecha_vist").dateDropper({
        format: "d/m/Y",
        dropPrimaryColor: "#26DD79"
    });

    $("#edit_fecha_vist").dateDropper({
        format: "d/m/Y",
        dropPrimaryColor: "#26DD79"
    });


    $("#Fecha_Programacion").dateDropper({
        format: "d/m/Y",
        dropPrimaryColor: "#26DD79",
        minYear: "2019",
        maxYear: "2020",
